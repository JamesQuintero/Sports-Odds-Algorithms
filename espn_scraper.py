...
class ESPN_Scraper:
	...
	def update_data(self, team, year):
		...
		for x in range(start, end):
			...
			existing_data=self.universal.load_data(team, "")
...
if __name__=="__main__":
	...
	# espn_scraper.update_data(['bal','baltimore-orioles'], "")
	# espn_scraper.update_data(['bos','boston-red-sox'], "")
	# espn_scraper.update_data(['chc','chicago-cubs'], "")
	# espn_scraper.update_data(['chw','chucago-white-sox'], "")
	# espn_scraper.update_data(['cin','cincinnati-reds'], "")
	# espn_scraper.update_data(['cle','cleveland-indians'], "")
	# espn_scraper.update_data(['col','colorado-rockies'], "")
	# espn_scraper.update_data(['det','detroit-tigers'], "")
	# espn_scraper.update_data(['hou','houston-astros'], "")
	# espn_scraper.update_data(['kc','kansas-city-royals'], "")
	# espn_scraper.update_data(['laa','los-angeles-angels'], "")
	# espn_scraper.update_data(['lad','los-angeles-dodgers'], "")
	# espn_scraper.update_data(['mia','miami-marlins'], "")
	# espn_scraper.update_data(['mil','milwaukee-brewers'], "")
	# espn_scraper.update_data(['min','minnesota-twins'], "")
	# espn_scraper.update_data(['nym','new-york-mets'], "")
	# espn_scraper.update_data(['nyy','new-york-yankees'], "")
	# espn_scraper.update_data(['oak','oakland-athletics'], "")
	# espn_scraper.update_data(['phi','philadelphia-phillies'], "")
	# espn_scraper.update_data(['pit','pittsburgh-pirates'], "")
	# espn_scraper.update_data(['sd','san-diego-padres'], "")
	# espn_scraper.update_data(['sf','san-francisco-giants'], "")
	# espn_scraper.update_data(['sea','seattle-mariners'], "")
	# espn_scraper.update_data(['stl','st.-louis-cardinals'], "")
	# espn_scraper.update_data(['tb','tampa-bay-rays'], "")
	# espn_scraper.update_data(['tex','texas-rangers'], "")
	# espn_scraper.update_data(['tor','toronto-blue-jays'], "")
	...
	# espn_scraper.update_data(['atl','atlanta-hawks'], "2016")
	# espn_scraper.update_data(['bos','boston-celtics'], "2016")
	# espn_scraper.update_data(['bkn','brooklyn-nets'], "2016")
	# espn_scraper.update_data(['cha','charlotte-hornets'], "2016")
	# espn_scraper.update_data(['chi','chicago-bulls'], "2016")
	# espn_scraper.update_data(['cle','cleveland-cavaliers'], "2016")
	# espn_scraper.update_data(['dal','dallas-mavericks'], "2016")
	# espn_scraper.update_data(['den','denver-nuggets'], "2016")
	# espn_scraper.update_data(['det','detroit-pistons'], "2016")
	# espn_scraper.update_data(['gs','golden-state-warriors'], "2016")
	# espn_scraper.update_data(['hou','houston-rockets'], "2016")
	# espn_scraper.update_data(['ind','indiana-pacers'], "2016")
	# espn_scraper.update_data(['lac','los-angeles-clippers'], "2016")
	# espn_scraper.update_data(['lal','los-angeles-lakers'], "2016")
	# espn_scraper.update_data(['mem','memphis-grizzlies'], "2016")
	# espn_scraper.update_data(['mia','miami-heat'], "2016")
	# espn_scraper.update_data(['mil','milwaukee-bucks'], "2016")
	# espn_scraper.update_data(['min','minnesota-timberwolves'], "2016")
	# espn_scraper.update_data(['no','new-orleans-pelicans'], "2016")
	# espn_scraper.update_data(['ny','new-york-knicks'], "2016")
	# espn_scraper.update_data(['okc','oklahoma-city-thunder'], "2016")
	# espn_scraper.update_data(['orl','orlando-magic'], "2016")
	# espn_scraper.update_data(['phi','philadelphia-76ers'], "2016")
	# espn_scraper.update_data(['phx','phoenix-suns'], "2016")
	# espn_scraper.update_data(['por','portland-trail-blazers'], "2016")
	# espn_scraper.update_data(['sac','sacramento-kings'], "2016")
	# espn_scraper.update_data(['sa','san-antonio-spurs'], "2016")
	# espn_scraper.update_data(['tor','toronto-raptors'], "2016")
	# espn_scraper.update_data(['utah','utah-jazz'], "2016")
	# espn_scraper.update_data(['wsh','washington-wizards'], "2016")
